...
const imageList = [
  { url: clImg("https://res.cloudinary.com/dzhvfbuks/image/upload/v1775479369/Harga_Promo_Grand_Duta_City_South_of_Jakarta_pbj2gv.webp", { w: 680, h: 850, q: 90 }), alt: "Harga Promo Grand Duta City South of Jakarta Parung" },
  { url: clImg("https://res.cloudinary.com/dzhvfbuks/image/upload/v1775479369/Kawasan_Grand_Duta_City_Parung_vusyk3.webp", { w: 680, h: 850, q: 90 }), alt: "Kawasan Perumahan Grand Duta City Parung" },
  { url: clImg("https://res.cloudinary.com/dzhvfbuks/image/upload/v1775479369/Lingkungan_Perumahan_Grand_Duta_City_South_of_Jakarta_uyfgbi.webp", { w: 680, h: 850, q: 90 }), alt: "Lingkungan Perumahan Grand Duta City South of Jakarta" },
  { url: clImg("https://res.cloudinary.com/dzhvfbuks/image/upload/v1775479369/Fasad_GDC_ptpex3.webp", { w: 680, h: 850, q: 90 }), alt: "Fasad Rumah Grand Duta City Parung" },
  { url: clImg("https://res.cloudinary.com/dzhvfbuks/image/upload/v1775479369/Lingkungan_GDC_Parung_aw7ljq.webp", { w: 680, h: 850, q: 90 }), alt: "Lingkungan Asri GDC Parung" },
  { url: clImg("https://res.cloudinary.com/dzhvfbuks/image/upload/v1775479369/GDC_Parung_lbfaw3.webp", { w: 680, h: 850, q: 90 }), alt: "Fasilitas Grand Duta City Parung" },
];
          ...
          >
            <div className="relative w-full h-full rounded-[calc(2rem-0.5rem)] overflow-hidden bg-black/5 shadow-[inset_0_1px_1px_rgba(255,255,255,0.4)]">
              <Image
                ...
                alt={img.alt}
                fill
                sizes="(max-width: 480px) 340px, (max-width: 768px) 50vw, (max-width: 1024px) 50vw, 420px"
                loading="lazy"
