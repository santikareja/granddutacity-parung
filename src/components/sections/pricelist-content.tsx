        ...
        <div className="max-w-screen-xl mx-auto px-6 md:px-14 lg:px-20 py-20 relative z-10">
          ...
          <div className="mt-16 pt-10 border-t border-[#0b120c]/10 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-3">
               ...
               <Link href="/update-stok-siteplan-gdc-parung" className="px-5 py-2.5 rounded-xl border border-[#0b120c]/10 bg-[#F5F1E8] hover:bg-[#F5F1E8] text-[#0b120c]/70 hover:text-[#F5A524] hover:border-[#F5A524]/30 transition-all text-xs font-semibold uppercase tracking-wider">cek stok dan siteplan terbaru</Link>
